        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="relative aspect-[4/5] max-w-md mx-auto">
              <div className="absolute inset-0 bg-bdm-gold translate-x-4 translate-y-4 z-0"></div>
              <img
                src="/about_image.png"
              ...
              />
              {/* Decorative elements */}
              <div className="absolute -top-6 -left-6 w-24 h-24 border-t-2 border-l-2 border-bdm-gold z-20"></div>
              <div className="absolute -bottom-6 -right-6 w-24 h-24 border-b-2 border-r-2 border-bdm-gold z-20"></div>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-5xl md:text-7xl font-bebas text-bdm-white mb-6 uppercase">
              Del barrio al <span className="text-bdm-gold">mundo</span>
            </h2>
            <div className="w-20 h-1 bg-bdm-gold mb-8"></div>
