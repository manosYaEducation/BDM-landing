        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {events.map((evt, idx) => (
            <motion.div
              ...
              className="p-5 flex flex-col h-full bg-bdm-black/20 backdrop-blur-sm border border-bdm-dark text-white transition-all duration-300 hover:-translate-y-2 hover:bg-bdm-red hover:text-bdm-black hover:border-bdm-red group"
            >
